<template>
    <div  class="d-flex flex-column">
        ...
        <div class="body-df d-flex p-3 flex-column">
            <div class="d-flex select-df justify-content-around">
            ...
            <div class="d-flex app-button-df justify-content-end mt-3">
                <a-button class=" h-100 mr-2">产品上架</a-button>
                <a-button class="h-100 mr-2">产品下架</a-button>
                <a-button class="h-100 mr-2">创建产品</a-button>
            </div>
            <div class="mt-2">
                <a-table
...
<script lang="ts">
    ...
    export default Vue.extend({
        ...
        methods: {
            initAppList(){
                ApiService.get(appsApi.selectAppList.url, {}, AuthService.createAuthHeaders()).then((res: RestfulResponse) => {
                    if(res.code === '1') {
                        this.data = res.data;
                    } else {
